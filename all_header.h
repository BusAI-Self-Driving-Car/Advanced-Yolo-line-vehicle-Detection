...
public:
	...
	void curvature_sanity_check(vector<float>&polyleft_in, vector<float>&polyright_in, float &center_dist, float &left_curverad, float &right_curverad, vector<int>&Leftx, vector<int>&rightx, vector<int>&main_y);
